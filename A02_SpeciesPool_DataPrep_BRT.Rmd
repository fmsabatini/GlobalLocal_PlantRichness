...
```{r, message=F, eval=T}
ISRIC.stack <- stack(list.files("/data/sPlot/users/Francesco/Ancillary_Data/ISRIC/", 
...
write_csv(as.data.frame(pca.envfit.chelsa$vectors[[1]]), 
          path ="../sPlot/_derived_data/Resample1/Envfit_Climate.csv")
...
#save
ggsave(PC.climate.grid, filename = "../sPlot/_derived_data/Resample1/_pics/PCA_climate.png", width=10, height=5, dpi=600)
...
write_csv(as.data.frame(pca.envfit$vectors[[1]]), 
          path ="../sPlot/_derived_data/Resample1/Envfit_Soil.csv")
...
#save
ggsave(PC.isric.grid, filename = "../sPlot/_derived_data/Resample1/_pics/PCA_isric.png", width=10, height=5, dpi=300)
...
Save world.over
```{r, eval=T}
save(world.over, file="../sPlot/_derived_data/world.over.RData")
```
...
save(mydata, file="../sPlot/_derived_data/Resample1/Mydata_global.RData")
...
```{r}
load(file="../sPlot/_derived_data/Resample1/Mydata_global.RData")
...
## save graph
png(file="../sPlot/_derived_data/Resample1/_pics/FigS5_Correlations.png", width=10, height=7.2, units = "in", res=300)
corrplot(res, type = "upper", 
         tl.col = "black", tl.srt = 45, number.cex=0.6, addCoef.col = "black", tl.cex = 0.7)
dev.off()
```
